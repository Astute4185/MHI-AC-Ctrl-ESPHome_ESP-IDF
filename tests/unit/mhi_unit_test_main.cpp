...
int main() {
  ...
  protocol_capture_first_frame_is_baseline();
  protocol_capture_unchanged_frame_is_suppressed();
  protocol_capture_reports_payload_change_and_xor();
  protocol_capture_tracks_reverse_transition_from_latest_state();
  protocol_capture_ignores_checksum_only_change();
  protocol_capture_keeps_opdata_keys_separate();
  protocol_capture_keeps_frame_kinds_separate();
  protocol_capture_length_change_rebaselines_identity();
  protocol_capture_rejects_invalid_frame_length();
  protocol_capture_33_byte_tracks_db26_and_ignores_checksums();
  protocol_capture_caps_reported_changes_but_counts_all();
  protocol_capture_reset_forces_new_baseline();
  protocol_capture_recycles_oldest_slot_when_full();
